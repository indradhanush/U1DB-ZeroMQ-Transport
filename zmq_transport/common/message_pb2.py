...
_SENDDOCUMENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_generation', full_name='zmq_transport.common.SendDocumentRequest.doc_generation', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='doc_content', full_name='zmq_transport.common.SendDocumentRequest.doc_content', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_generation', full_name='zmq_transport.common.SendDocumentRequest.source_generation', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_transaction_id', full_name='zmq_transport.common.SendDocumentRequest.source_transaction_id', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='target_last_known_generation', full_name='zmq_transport.common.SendDocumentRequest.target_last_known_generation', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='target_last_known_trans_id', full_name='zmq_transport.common.SendDocumentRequest.target_last_known_trans_id', index=9,
...
_ALLSENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='source_replica_uid', full_name='zmq_transport.common.AllSentRequest.source_replica_uid', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='total_docs_sent', full_name='zmq_transport.common.AllSentRequest.total_docs_sent', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='all_sent', full_name='zmq_transport.common.AllSentRequest.all_sent', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='target_last_known_generation', full_name='zmq_transport.common.AllSentRequest.target_last_known_generation', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='target_last_known_trans_id', full_name='zmq_transport.common.AllSentRequest.target_last_known_trans_id', index=5,
...
_GETDOCUMENTREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='docs_received_count', full_name='zmq_transport.common.GetDocumentRequest.docs_received_count', index=3,
      number=4, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='target_last_known_generation', full_name='zmq_transport.common.GetDocumentRequest.target_last_known_generation', index=4,
      number=5, type=5, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='target_last_known_trans_id', full_name='zmq_transport.common.GetDocumentRequest.target_last_known_trans_id', index=5,
      number=6, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
